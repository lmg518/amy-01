...
public class PositionUtil {  
     ...
     * @return
     */
    public static Gps Wgs84_To_bd09(double bd_lat,double bd_lon){
    	Gps gcj02 = PositionUtil.gps84_To_Gcj02(bd_lat, bd_lon);//将WGS84坐标系转换为火星坐标系(GCJ)
    	Gps gpsBd09 = PositionUtil.gcj02_To_Bd09(gcj02.getWgLat(), gcj02.getWgLon());//将火星坐标系(GCJ)转换为百度坐标系（DB-09）
    	return gpsBd09;
    }

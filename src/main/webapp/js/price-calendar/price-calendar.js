...
}, 
{
    ...
    BOTTOM_TEMPLATE: '<p class="tips">' +
                    ...
                    '</p>' +
                    '<p class="btns">' +
                        '<input type="button" style="height:80px;font-size:30px;" value="\u786e\u5b9a" class="confirm-btn" />' +
                        '<input type="button" style="height:80px;font-size:30px;" value="\u53d6\u6d88" class="cancel-btn" />' +
                    '</p>',
    /**
     * 日历组件标识
     *
